...
"%SOATEST_EXE%\soatestcli.exe" -data %SOATEST_WORKSPACE% -resource %PROJECT_NAME% -config "user://Example Configuration" -report %SOATEST_WORKSPACE%\report -publish -localsettings %SOATEST_WORKSPACE%\soatest.properties
