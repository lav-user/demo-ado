...
"%SOATEST_EXE%\soatestcli.exe" -data %SOATEST_WORKSPACE% -resource %PROJECT_NAME% -config "user://Run Test with Application Coverage" -report %SOA_WORKSPACE%\report -publish -localsettings %SOA_WORKSPACE%\soatest.properties
